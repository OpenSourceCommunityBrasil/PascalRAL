...
begin
  case AValue of
    ...
    46:
      DataType := ftExtended;
    47:
      DataType := ftConnection;
    48:
      DataType := ftParams;
    49:
      DataType := ftStream;
    50:
      DataType := ftTimeStampOffset;
    51:
      DataType := ftObject;
    52:
      DataType := ftSingle;
...
begin
  case FDataType of
    ...
    ftSmallint:
      Result := GetFieldInteger;
    ftInteger:
      Result := GetFieldInteger;
    ftWord:
      Result := GetFieldInteger;
    ftBoolean:
      Result := GetFieldBoolean;
    ftFloat:
      Result := GetFieldFloat;
    ftCurrency:
      Result := GetFieldFloat;
    ftBCD:
      Result := GetFieldFloat;
    ftDate:
      Result := GetFieldDateTime(1);
    ftTime:
      Result := GetFieldDateTime(2);
    ftDateTime:
      Result := GetFieldDateTime(3);
    ftBytes:
      Result := GetFieldBytes;
    ftVarBytes:
      Result := GetFieldBytes;
    ftAutoInc:
      Result := GetFieldInteger;
...
begin
  ...
  case FDataType of
    ...
    ftIDispatch:
      FillZeroSize;
    ftGuid:
      FillZeroSize(38); // '{81DB70A9-82C1-4303-9E7B-356044316D71}'
    ftTimeStamp:
      FSize := SizeOf(TDateTime);
    ftFMTBcd:
      FSize := SizeOf(TDateTime);
...
begin
  ...
  if FDataType in [ftString, ftFixedChar, ftWideString, ftFixedWideChar] then
    FSize := AValue;
end;
...
function TRALStorageField.GetAsBoolean: boolean;
  ...
  begin
    ...
    begin
      vStr := ReadString;
      StringToBoolean := (vStr = 'S') or (vStr = 'V') or (vStr = 'T') or (vStr = '1');
    end
    else
    begin
...
begin
  case FDataType of
    ftUnknown:
      Result := False;
    ftString:
      Result := StringToBoolean;
    ftSmallint:
      Result := ReadSmallint = 1;
    ftInteger:
    ...
    ftBoolean:
      Result := ReadBoolean;
    ftFloat:
      Result := ReadDouble = 1.0;
    ftCurrency:
      Result := ReadDouble = 1.0;
    ftBCD:
      Result := ReadDouble = 1.0;
    ftBytes:
      Result := BytesToBoolean;
    ftVarBytes:
      Result := BytesToBoolean;
    ftAutoInc:
      Result := ReadInt64 = 1;
    ...
    {$IFNDEF FPC}
    ftLongWord:
      Result := ReadLongWord = 1;
    ftShortint:
      Result := ReadShortInt = 1;
    ftByte:
      Result := ReadByte = 1;
    ftExtended:
      Result := ReadDouble = 1.0;
...
begin
  case FDataType of
    ftString:
      Result := StringToDateTime;
    ftSmallint:
      Result := TDateTime(ReadSmallint);
    ftInteger:
      Result := TDateTime(ReadInteger);
    ftWord:
      Result := TDateTime(ReadWord);
    ftFloat:
    ...
    ftDateTime:
      Result := ReadDateTime;
    ftBytes:
      Result := BytesToDateTime;
    ftVarBytes:
      Result := BytesToDateTime;
    ftAutoInc:
      Result := TDateTime(ReadInt64);
    ftBlob:
      Result := BytesToDateTime;
    ftMemo:
      Result := StringToDateTime;
    ...
    ftOraInterval:
      Result := ReadDateTime;
    ftLongWord:
      Result := TDateTime(ReadLongWord);
    ftShortint:
      Result := TDateTime(ReadShortInt);
    ftByte:
      Result := TDateTime(ReadByte);
    ftExtended:
      Result := TDateTime(ReadDouble);
    ftStream:
      Result := BytesToDateTime;
...
begin
  case FDataType of
    ...
    ftBCD:
      Result := ReadDouble;
    ftDate:
      Result := Double(ReadDateTime);
    ftTime:
      Result := Double(ReadDateTime);
    ftDateTime:
      Result := Double(ReadDateTime);
    ftBytes:
      Result := BytesToDouble;
    ftVarBytes:
      Result := BytesToDouble;
    ftAutoInc:
      Result := ReadInt64;
...
begin
  case FDataType of
    ftString:
      Result := StringToInteger;
    ftSmallint:
      Result := IntegerRAL(ReadSmallint);
    ftInteger:
      Result := ReadInteger;
    ftWord:
      Result := IntegerRAL(ReadWord);
    ftBoolean:
      Result := BooleanToInteger;
    ftFloat:
      Result := IntegerRAL(Trunc(ReadDouble));
    ftCurrency:
      Result := IntegerRAL(Trunc(ReadDouble));
    ftBCD:
      Result := IntegerRAL(Trunc(ReadDouble));
    ftDate:
      Result := IntegerRAL(Trunc(ReadDateTime));
    ftTime:
      Result := IntegerRAL(Trunc(ReadDateTime));
    ftDateTime:
      Result := IntegerRAL(Trunc(ReadDateTime));
    ftBytes:
      Result := BytesToInteger;
    ftVarBytes:
      Result := BytesToInteger;
    ftAutoInc:
      Result := IntegerRAL(ReadInt64);
    ftBlob:
      Result := BytesToInteger;
    ftMemo:
      Result := StringToInteger;
    ...
    ftOraInterval:
      Result := IntegerRAL(Trunc(ReadDateTime));
    ftLongWord:
      Result := IntegerRAL(ReadLongWord);
    ftShortint:
      Result := IntegerRAL(ReadShortInt);
    ftByte:
      Result := IntegerRAL(ReadByte);
    ftExtended:
      Result := IntegerRAL(Trunc(ReadDouble));
    ftStream:
      Result := BytesToInteger;
...
begin
  case FDataType of
    ftString:
      Result := StringToInteger;
    ftSmallint:
      Result := Int64RAL(ReadSmallint);
    ftInteger:
      Result := Int64RAL(ReadInteger);
    ftWord:
      Result := Int64RAL(ReadWord);
    ftBoolean:
      Result := BooleanToInteger;
    ftFloat:
      Result := Int64RAL(Trunc(ReadDouble));
    ftCurrency:
      Result := Int64RAL(Trunc(ReadDouble));
    ftBCD:
      Result := Int64RAL(Trunc(ReadDouble));
    ftDate:
      Result := Int64RAL(Trunc(ReadDateTime));
    ftTime:
      Result := Int64RAL(Trunc(ReadDateTime));
    ftDateTime:
      Result := Int64RAL(Trunc(ReadDateTime));
    ...
    ftOraInterval:
      Result := Int64RAL(Trunc(ReadDateTime));
    ftLongWord:
      Result := Int64RAL(ReadLongWord);
    ftShortint:
      Result := Int64RAL(ReadShortInt);
    ftByte:
      Result := Int64RAL(ReadByte);
    ftExtended:
      Result := Int64RAL(Trunc(ReadDouble));
    ftStream:
      Result := BytesToInteger;
...
begin
  case FDataType of
    ftString:
      Result := ReadString;
    ftSmallint:
      Result := IntToStr(ReadSmallint);
    ftInteger:
      Result := IntToStr(ReadInteger);
    ftWord:
      Result := IntToStr(ReadWord);
    ftBoolean:
      Result := BooleanToString;
    ftFloat:
      Result := FloatToStr(ReadDouble);
    ftCurrency:
      Result := FloatToStr(ReadDouble);
    ftBCD:
      Result := FloatToStr(ReadDouble);
    ftDate:
      Result := FormatDateTime('yyyyMMdd', ReadDateTime);
    ftTime:
      Result := FormatDateTime('hhnnsszzz', ReadDateTime);
    ftDateTime:
      Result := FormatDateTime('yyyyMMddhhnnsszzz', ReadDateTime);
    ftBytes:
      Result := ReadString;
    ftVarBytes:
      Result := ReadString;
    ...
    ftOraInterval:
      Result := FormatDateTime('yyyyMMddhhnnsszzz', ReadDateTime);
    ftLongWord:
      Result := IntToStr(ReadLongWord);
    ftShortint:
      Result := IntToStr(ReadShortInt);
    ftByte:
      Result := IntToStr(ReadByte);
    ftExtended:
      Result := FloatToStr(ReadDouble);
    ftStream:
      Result := ReadString;
...
begin
  ...
  case FDataType of
    ftString:
      WriteString(BooleanToString);
    ftSmallint:
      WriteSmallint(SmallInt(BooleanToInteger));
    ftInteger:
      WriteInteger(BooleanToInteger);
    ftWord:
      WriteWord(Word(BooleanToInteger));
    ftBoolean:
      WriteBoolean(AValue);
    ftFloat:
      WriteDouble(BooleanToDouble);
    ftCurrency:
      WriteDouble(BooleanToDouble);
    ftBCD:
      WriteDouble(BooleanToDouble);
    ftBytes:
      WriteBytes(BooleanToBytes);
    ftVarBytes:
      WriteBytes(BooleanToBytes);
    ftAutoInc:
      WriteInt64(Int64RAL(BooleanToInteger));
    ftBlob:
      WriteBytes(BooleanToBytes);
    ftMemo:
      WriteString(BooleanToString);
    ...
    {$IFNDEF FPC}
    ftLongWord:
      WriteLongWord(LongWord(BooleanToInteger));
    ftShortint:
      WriteShortInt(ShortInt(BooleanToInteger));
    ftByte:
      WriteByte(Byte(BooleanToInteger));
    ftExtended:
      WriteDouble(BooleanToDouble);
    ftStream:
      WriteBytes(BooleanToBytes);
...
begin
  ...
  case FDataType of
    ftString:
      WriteString(DateTimeToString);
    ftSmallint:
      WriteSmallint(SmallInt(DateTimeToInteger));
    ftInteger:
      WriteInteger(DateTimeToInteger);
    ftWord:
      WriteWord(Word(DateTimeToInteger));
    ftFloat:
    ...
    ftBCD:
      WriteDouble(Double(AValue));
    ftDate:
      WriteDateTime(TDateTime(Trunc(AValue)));
    ftTime:
      WriteDateTime(TDateTime(Frac(AValue)));
    ftDateTime:
      WriteDateTime(AValue);
    ftBytes:
      WriteBytes(DateTimeToBytes);
    ftVarBytes:
      WriteBytes(DateTimeToBytes);
    ftAutoInc:
      WriteInt64(Int64RAL(DateTimeToInteger));
    ftBlob:
      WriteBytes(DateTimeToBytes);
    ftMemo:
      WriteString(DateTimeToString);
    ...
    ftOraInterval:
      WriteDateTime(AValue);
    ftLongWord:
      WriteLongWord(LongWord(DateTimeToInteger));
    ftShortint:
      WriteShortInt(ShortInt(DateTimeToInteger));
    ftByte:
      WriteByte(Byte(DateTimeToInteger));
    ftExtended:
      WriteDouble(Double(AValue));
    ftStream:
      WriteBytes(DateTimeToBytes);
...
begin
  ...
  case FDataType of
    ftString:
      WriteString(FloatToStr(AValue));
    ftSmallint:
      WriteSmallint(SmallInt(Trunc(AValue)));
    ftInteger:
      WriteInteger(Trunc(AValue));
    ftWord:
      WriteWord(Word(Trunc(AValue)));
    ftBoolean:
      WriteBoolean(DoubleToBoolean);
    ftFloat:
      WriteDouble(AValue);
    ftCurrency:
      WriteDouble(AValue);
    ...
    ftTime:
      WriteDateTime(TDateTime(Frac(AValue)));
    ftDateTime:
      WriteDateTime(TDateTime(AValue));
    ftBytes:
      WriteBytes(DoubleToBytes);
    ftVarBytes:
      WriteBytes(DoubleToBytes);
    ftAutoInc:
      WriteInt64(Trunc(AValue));
    ftBlob:
      WriteBytes(DoubleToBytes);
    ftMemo:
      WriteString(FloatToStr(AValue));
    ...
    ftOraInterval:
      WriteDateTime(TDateTime(AValue));
    ftLongWord:
      WriteLongWord(LongWord(Trunc(AValue)));
    ftShortint:
      WriteShortInt(ShortInt(Trunc(AValue)));
    ftByte:
      WriteByte(Byte(Trunc(AValue)));
    ftExtended:
      WriteDouble(AValue);
    ftStream:
      WriteBytes(DoubleToBytes);
...
begin
  ...
  case FDataType of
    ...
    ftSmallint:
      WriteSmallint(SmallInt(AValue));
    ftInteger:
      WriteInteger(AValue);
    ftWord:
      WriteWord(Word(AValue));
    ftBoolean:
      WriteBoolean(IntegerToBoolean);
    ftFloat:
      WriteDouble(Double(AValue));
    ftCurrency:
      WriteDouble(Double(AValue));
    ...
    ftDate:
      WriteDateTime(TDateTime(AValue));
    ftTime:
      WriteDateTime(TDateTime(0));
    ftDateTime:
      WriteDateTime(TDateTime(AValue));
    ftBytes:
      WriteBytes(IntegerToBytes);
    ftVarBytes:
      WriteBytes(IntegerToBytes);
    ftAutoInc:
      WriteInt64(Int64RAL(AValue));
    ftBlob:
      WriteBytes(IntegerToBytes);
    ftMemo:
      WriteString(IntToStr(AValue));
    ...
    ftOraInterval:
      WriteDateTime(TDateTime(AValue));
    ftLongWord:
      WriteLongWord(LongWord(AValue));
    ftShortint:
      WriteShortInt(ShortInt(AValue));
    ftByte:
...
begin
  ...
  case FDataType of
    ...
    ftSmallint:
      WriteSmallint(SmallInt(AValue));
    ftInteger:
      WriteInteger(IntegerRAL(AValue));
    ftWord:
      WriteWord(Word(AValue));
    ftBoolean:
      WriteBoolean(IntegerToBoolean);
...
procedure TRALStorageField.SetAsString(AValue: StringRAL);
  ...
  function StringToBoolean: boolean;
  begin
    Result := (AValue = 'S') or (AValue = 'T') or (AValue = 'V') or (AValue = '1');
  end;
...
begin
  ...
  case FDataType of
    ftString:
      WriteString(AValue);
    ftSmallint:
      WriteSmallint(SmallInt(StringToInteger));
    ftInteger:
      WriteInteger(IntegerRAL(StringToInteger));
    ftWord:
      WriteWord(Word(StringToInteger));
    ftBoolean:
      WriteBoolean(StringToBoolean);
    ftFloat:
      WriteDouble(StringToDouble);
    ftCurrency:
      WriteDouble(StringToDouble);
    ftBCD:
      WriteDouble(StringToDouble);
    ftDate:
      WriteDateTime(StringToDateTime);
    ftTime:
      WriteDateTime(StringToDateTime);
    ftDateTime:
      WriteDateTime(StringToDateTime);
    ftBytes:
      WriteBytes(StringToBytes);
    ftVarBytes:
      WriteBytes(StringToBytes);
    ftAutoInc:
      WriteInt64(StringToInteger);
    ftBlob:
      WriteBytes(StringToBytes);
    ftMemo:
      WriteString(AValue);
    ...
    ftOraInterval:
      WriteDateTime(StringToDateTime);
    ftLongWord:
      WriteLongWord(LongWord(StringToInteger));
    ftShortint:
      WriteShortInt(ShortInt(StringToInteger));
    ftByte:
      WriteByte(Byte(StringToInteger));
    ftExtended:
      WriteDouble(StringToDouble);
    ftStream:
      WriteBytes(StringToBytes);
  ...
  begin
    ...
    begin
      case AField.DataType of
        ftSmallint, ftInteger, ftAutoInc, ftLargeint, ftWord:
          vField.AsInteger := AField.AsInteger;
        ftBoolean:
          vField.AsBoolean := AField.AsBoolean;
        ftFloat, ftCurrency, ftBCD, ftFMTBcd:
          vField.AsDouble := AField.AsFloat;
        ftTimeStamp, ftDate, ftTime, ftDateTime:
          vField.AsDateTime := AField.AsDateTime;
        ftBytes, ftVarBytes:
          vField.AsBytes := AField.AsBytes;
        ftBlob, ftGraphic, ftOraBlob:
          SaveAsStream;
        ftUnknown, ftParadoxOle, ftDBaseOle, ftTypedBinary, ftCursor, ftADT, ftArray,
          ftReference, ftDataSet, ftVariant, ftInterface, ftIDispatch:
          vField.Clear;
        ftMemo, ftFmtMemo, ftFixedChar, ftWideString, ftOraClob, ftGuid, ftFixedWideChar,
          ftWideMemo, ftString:
          vField.AsString := AField.AsString;
        {$IFNDEF FPC}
        ftOraTimeStamp, ftOraInterval, ftTimeStampOffset:
          vField.AsDateTime := AField.AsDateTime;
        ftLongWord, ftShortint, ftByte:
          vField.AsInteger := AField.AsInteger;
        ftExtended, ftSingle:
          vField.AsDouble := AField.AsFloat;
        ftConnection, ftParams, ftObject:
          vField.Clear;
        ftStream:
          SaveAsStream;
        {$ENDIF}
...
begin
  ...
  begin
    ...
    begin
      case AField.DataType of
        ftString:
          AField.AsString := vField.AsString;
        ftSmallint:
          AField.AsInteger := vField.AsInteger;
        ftInteger:
          AField.AsInteger := vField.AsInteger;
        ftWord:
          AField.AsInteger := vField.AsInteger;
        ftBoolean:
          AField.AsBoolean := vField.AsBoolean;
        ftFloat:
          AField.AsFloat := vField.AsDouble;
        ftCurrency:
          AField.AsFloat := vField.AsDouble;
        ftBCD:
          AField.AsFloat := vField.AsDouble;
        ftDate:
          AField.AsDateTime := vField.AsDateTime;
        ftTime:
          AField.AsDateTime := vField.AsDateTime;
        ftDateTime:
          AField.AsDateTime := vField.AsDateTime;
        ftBytes:
          AField.AsBytes := vField.AsBytes;
        ftVarBytes:
          AField.AsBytes := vField.AsBytes;
        ftAutoInc:
          AField.AsLargeInt := vField.AsLargeInt;
        ftBlob:
          ReadAsStream;
        ftMemo:
          AField.AsString := vField.AsString;
        ...
        ftByte:
          AField.AsInteger := vField.AsInteger;
        ftExtended:
          AField.AsExtended := vField.AsDouble;
        ftConnection:
          AField.Clear;
        ftParams:
          AField.Clear;
        ...
        ftObject:
          AField.Clear;
        ftSingle:
          AField.AsSingle := vField.AsDouble;
        {$ENDIF}
      end;
    end;
  end;
...
begin
  ...
  begin
    ...
    if vField.DataType in [ftString, ftFixedChar, ftFixedWideChar, ftWideString] then
...
function TRALStorage.AddField(const AName: string; ADataType: TFieldType; ASize: integer)
  : TRALStorageField;
begin
...
function TRALStorage.AddField(const AName: string; ADataType: TFieldType)
  : TRALStorageField;
begin
